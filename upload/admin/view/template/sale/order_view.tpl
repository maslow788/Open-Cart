      ...
      <div style="margin-bottom: 15px;">
        ...
        <div style="background: #FCFCFC; border: 1px solid #8EAEC3; padding: 10px;">
          <table class="list">
            <thead>
              <tr>
                <td class="left" width="20%"><b><?php echo $text_order; ?></b></td>
                <td class="left" width="20%"><b><?php echo $text_store; ?></b></td>
                <td class="left" width="20%"><b><?php echo $text_date_added; ?></b></td>
                <td class="left" width="20%"><b><?php echo $text_payment_method; ?></b></td>
                <td class="left" width="20%"><b><?php echo $text_shipping_method; ?></b></td>
              </tr>
            </thead>
            <tbody>
              <tr>
